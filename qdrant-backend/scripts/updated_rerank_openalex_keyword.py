...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Re-rank OpenAlex works based on multiple abstracts (and optional user keywords)."
    )
    parser.add_argument(
        "--keywords",
        type=str,
    ...
    user_keywords_raw = args.keywords.strip()
    max_terms = 3
    ...
    for w in all_works_by_id.values():
        ...
        # Her query embedding'iyle ayrı ayrı similarity (cosine, çünkü normalize)
